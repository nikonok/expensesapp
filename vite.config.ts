...
export default defineConfig({
  plugins: [
    ...
    // that libsodium can compile WASM in the dev playground.
  ...
  server: {
    // Allow WebAssembly compilation in the dev server (needed for libsodium).
    // 'wasm-unsafe-eval' is required by Chromium to compile WASM via
    // WebAssembly.instantiate / WebAssembly.instantiateStreaming in dev mode.
    headers: {
