...
DROP INDEX IF EXISTS idx_held_deliver;
DROP TABLE IF EXISTS held_notifications;
DROP TABLE IF EXISTS notification_settings;
DROP INDEX IF EXISTS idx_push_device;
DROP TABLE IF EXISTS push_subscriptions;
DROP TABLE IF EXISTS snapshot_entries;
DROP TABLE IF EXISTS snapshots;
DROP TABLE IF EXISTS family_seq;
DROP INDEX IF EXISTS idx_record_meta_deleted;
DROP INDEX IF EXISTS idx_record_meta_family_type;
DROP INDEX IF EXISTS idx_record_meta_seq;
DROP TABLE IF EXISTS record_meta;
DROP INDEX IF EXISTS idx_blobs_family;
DROP TABLE IF EXISTS blobs;
DROP TABLE IF EXISTS family_recovery_envelopes;
DROP TABLE IF EXISTS device_envelopes;
DROP TABLE IF EXISTS reauth_grants;
DROP TABLE IF EXISTS reauth_challenges;
DROP INDEX IF EXISTS idx_sessions_token_hash;
DROP TABLE IF EXISTS sessions;
DROP INDEX IF EXISTS idx_devices_status;
DROP INDEX IF EXISTS idx_devices_user;
DROP TABLE IF EXISTS devices;
DROP INDEX IF EXISTS idx_family_invites_invitee;
...
DROP INDEX IF EXISTS idx_users_delete_after;
DROP INDEX IF EXISTS idx_users_promoter;
