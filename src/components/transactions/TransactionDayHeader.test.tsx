...
describe("TransactionDayHeader", () => {
  it("renders the day number from the date", () => {
    render(
      <TransactionDayHeader date="2026-04-13" totalIncome={0} totalExpense={0} currency="USD" />,
    );
  ...
  it("hides income amount when totalIncome is 0", () => {
    render(
      <TransactionDayHeader date="2026-04-13" totalIncome={0} totalExpense={5000} currency="USD" />,
    );
  ...
  it("renders correctly for a date at start of month", () => {
    render(
      <TransactionDayHeader date="2026-01-01" totalIncome={0} totalExpense={0} currency="USD" />,
    );
  ...
  it("renders correctly for a date at end of month", () => {
    render(
      <TransactionDayHeader date="2026-03-31" totalIncome={0} totalExpense={0} currency="USD" />,
    );
