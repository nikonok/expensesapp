      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
            <h2 id="install-popup-title" style={{ fontFamily: 'Syne, sans-serif', fontSize: 'var(--text-subheading)', color: 'var(--color-text)', margin: 0 }}>
          ...
          {countdown > 0 && (
            <p style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--text-caption)', color: 'var(--color-text-secondary)', margin: 0 }}>
          ...
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
            <button
              ...
              onClick={async () => {
                setInstalling(true);
                try { await triggerInstall(); } finally {
                  setShowInstallPrompt(false);
                }
              }}
              style={{
