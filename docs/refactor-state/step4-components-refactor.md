...
**Suggested fix**: Extract to CSS module with BEM classes (accountDetail__section, accountDetail__progress, etc.).
...
- **Fix**: Create comprehensive CSS module strategy; use design tokens (--space-*, --color-*, --text-*) consistently.
