...
const VALID_SETTING_KEYS = new Set([
  'mainCurrency', 'language', 'startupScreen', 'notificationEnabled',
  'notificationTime', 'lastUsedAccountId', 'autoBackupIntervalHours',
  'lastAutoBackupAt', 'hasCompletedOnboarding'
]);
